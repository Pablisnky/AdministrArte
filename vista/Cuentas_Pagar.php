...
<html lang="es">
	...
	<body onload=""><!--llamar_cuentasPagar() llamar_cuentasPagar()se encuentra en funciones_Ajax.js -->
		<div id="Principal">
			<?php 
		...
		<div>
			<form action="../controlador/recibe_cuentasPagar.php" method="POST" autocomplete="off">
				<fieldset>
					<legend>Insertar nuevo deuda</legend>
					<table>
						<thead>
							<th>Fecha</th>
                            <th>Descripción</th>
						...
						<tbody>
							<tr>
								<td><input type="date" name="fecha" id="Calendario_CM"></td>
								<td><textarea name="descripcion"></textarea></td>
								<td><textarea name="acreedor"></textarea></td>
                                <td><input type="text" name="monto" id="Monto"></td>
                                <td><input type="text" id="<?php echo $A;?>" value="<?php echo $A;?>" hidden onclick="Detalles_CuentasPagar(this.id)"><label for="<?php echo $A;?>">Detalles</label></td>   
							</tr>
						</tbody>
					</table>
