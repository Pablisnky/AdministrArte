		...
		<div>
			<form autocomplete="off" name="formEstam" id="FormEstam">
				<fieldset class="fieldset_1">
					<legend class="legend_2">Tipo de vinilo adhesivo</legend>
				...
				<fieldset class="fieldset_1">
					...
					<input type="radio" name="anchoRollo" id="A_60" value="60" onclick="habilitar_RolloColor()">
					<label for="A_60">60 cm</label>
				</fieldset>

				<fieldset class="fieldset_1">
					<legend class="legend_2">Indique color</legend>
					<input type="radio" name="color" id="BlancoMate" value="blancoMate">
					<label for="Blanco">Blanco mate</label>
					<br>
				...
				<br>
				<input type="button" value="Calcular" onclick="llamar_PresupuestoAdhesivo()">
			</form>
		</div>
